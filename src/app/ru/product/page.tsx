...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "Это очередной курс по дропшиппингу?", a: "Нет. Это система органического трафика на 1 500+ магазинах, мой стек и движок-автопилот. Не 15 часов теории, а то, что приносит деньги." },
    ...
    <main className="min-h-screen bg-white text-zinc-900 selection:bg-lime-400/30 dark:bg-zinc-950 dark:text-zinc-50">
      ...
      <section className={SECTION}>
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-lg font-semibold leading-relaxed text-zinc-900 dark:text-white">Магазин собрать несложно. Сложно, чтобы тебя увидели без оплаты за каждый клик. Тут и делаются деньги. Это я и отдаю.</p>
        </div>
      </section>
